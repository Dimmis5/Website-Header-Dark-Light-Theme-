...
export const Hero = () => {
  return (
    <div className='isolate'>
                ...
                <div className='flex-1 space-y-6 lg:space-y-7'>
                    <div className='space-y-4 lg:space-y-5'>
                        ...
                        <p className='text-base lg:text-lg text-neutral-700 dark:text-neutral-300 max-w-2xl font-light'>
                            Elevate your web projects with our streamlined desgin system powered by the latest Tailwind CSS v4. Create stunning user experiences with state-of-the-art theme switching.
                        </p> 
                    ...
                    <div className='relative'>
                        ...
                        <div className='relative bg-white dark:bg-neutral-900 p-4 lg:p-5 xl:p-6 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800'>
                            ...
                            <div className='h-56 md:h-64 lg:h-60 xl:h-72 rounded-lg bg-neutral-100 dark:bg-neutral-800 overflow-hidden relative'>
                                <img src="/images/code-light.png" alt="Code snipper for light mode" className='w-full h-full object-cover object-left-top dark:hidden' />
                                <img src="/images/code-dark.png" alt="Code snipper for dark mode" className='w-full h-full object-cover object-left-top dark:block' />
        ...
        <div className='hidden md:block absolute bottem-8 left-8 lg:bottem-10 lg:left-10 animate-bounce'>
